...
export default function Modal(props) {
  ...
  return (
    <div
      className={`fixed w-full inset-0 block h-screen bg-transparent z-50 flex justify-center place-items-center ${
        isOpen ? "" : "hidden"
      }`}
    >
      <div
      ...
      <div
        className={`bg-gray-900 w-full h-screen bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-10 z-0 fixed ${
