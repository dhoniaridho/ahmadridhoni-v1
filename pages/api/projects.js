  ...
  const projects = [
    {
	  ...
	  description: "Made a showroom web app with Next JS as a framework. Fetched data using API built with Wordpress.",
    ...
    },
    {
	  ...
	  description: "Slicing a travel landing page with Next JS as a framework. designed by figma community",
    ...
    },
    {
	  ...
	  description: "Slicing a hosting landing page with Next JS as a framework. designed by figma community",
